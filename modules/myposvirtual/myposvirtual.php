...
class MyposVirtual extends PaymentModule
{
    ...
    private $fields = array('sid', 'wallet_number', 'private_key', 'public_certificate', 'key_index', 'ppr', 'payment_method');
    ...
    public function install()
    {
        ...
        Configuration::updateValue($this->scopes[0] . '_' . 'url', 'https://mypos.eu/vmp/checkout-test');
        Configuration::updateValue($this->scopes[1] . '_' . 'url', 'https://mypos.eu/vmp/checkout');

	    Configuration::updateValue($this->scopes[0] . '_' . 'ppr', '3');
	    Configuration::updateValue($this->scopes[1] . '_' . 'ppr', '3');

        Configuration::updateValue($this->scopes[0] . '_' . 'payment_method', '3');
        Configuration::updateValue($this->scopes[1] . '_' . 'payment_method', '3');
    ...
    public function getMyposVirtualConfig()
    {
	    ...
	    $config->setSource('sc_prestashop 1.10.1 ' . PHP_VERSION_ID . ' ' . _PS_VERSION_);
